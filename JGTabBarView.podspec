#
#  Be sure to run `pod spec lint JGTabBarView.podspec' to ensure this is a
...
# Or just: s.author    = "JungGate"
# s.authors            = { "JungGate" => "email@address.com" }
# s.social_media_url   = "http://twitter.com/JungGate"
...
s.source       = { :git => "https://github.com/junggate/JGTabBarView.git", :branch => "master", :tag => '1.0.0' }
